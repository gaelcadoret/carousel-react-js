...
var Caroussel = React.createClass({displayName: 'Caroussel',
    ...
    getIndicators: function() {
        if (this.props.showIndicators) {
            var liItems = this.props.data.map(function(content, idx) {
                return React.DOM.li( {key:"itemIndicator-" + idx})
            });
            return liItems
        }
    },
    ...
    render: function() {
        ...
        var liItems = this.props.data.map(function(content, idx) {
            return React.DOM.li( {style:{width: this.props.width}, key:"item-"+idx}, 
        ...
        return (
            React.DOM.div(null, 
                React.DOM.ul( {style:{width: this.props.width}, className:"carousselItemIndicators"}, 
                    this.getIndicators()
                ),
